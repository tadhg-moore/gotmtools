...
#' @param relh vector; relative humidity values (% [0-100]). Used to calculate dewpoint temperaure if that is not supplied.
...
#' @export
calc_in_lwr <- function(cc, airt, relh, dewt = NULL){
  if(is.null(dewt)){
